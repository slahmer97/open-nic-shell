...
*/
     .m_axil_core_awvalid(m_axil_core_awvalid),
      .m_axil_core_awaddr(m_axil_core_awaddr),
     .m_axil_core_awready(m_axil_core_awready),
     .m_axil_core_wvalid(m_axil_core_wvalid),
     .m_axil_core_wdata(m_axil_core_wdata),
     .m_axil_core_wready(m_axil_core_wready),
     .m_axil_core_bvalid(m_axil_core_bvalid),
     .m_axil_core_bresp(m_axil_core_bresp),
     .m_axil_core_bready(m_axil_core_bready),
     .m_axil_core_arvalid(m_axil_core_arvalid),
     .m_axil_core_araddr(m_axil_core_araddr),
     .m_axil_core_arready(m_axil_core_arready),
     .m_axil_core_rvalid(m_axil_core_rvalid),
     .m_axil_core_rdata(m_axil_core_rdata),
     .m_axil_core_rresp(m_axil_core_rresp),
     .m_axil_core_rready(m_axil_core_rready),
...
clk_wiz_50Mhz_0 clk_wiz_cms_inst (
    .clk_in1  (aclk),
    .resetn   (aresetn),
...
always @(posedge cms_clk) begin
  ...
  axi_lite_clock_converter_0 axi_clock_conv_qspi_inst (
...
axi_lite_clock_converter_0 axi_clock_conv_cms_inst (
